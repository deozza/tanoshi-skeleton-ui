<script lang="ts">
    ...
    const desktopWidth: string = tanoshiImageModel.desktopWidth !== null ? tanoshiImageModel.desktopWidth : tanoshiImageModel.width+'px';
    const desktopHeight: string = tanoshiImageModel.desktopHeight !== null ? tanoshiImageModel.desktopHeight : tanoshiImageModel.height+'px';
    const mobileWidth: string = tanoshiImageModel.mobileWidth !== null ? tanoshiImageModel.mobileWidth : tanoshiImageModel.width+'px';
    const mobileHeight: string = tanoshiImageModel.mobileHeight !== null ? tanoshiImageModel.mobileHeight : tanoshiImageModel.height+'px';
</script>
